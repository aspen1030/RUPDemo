...
This is the same model as the one we wrote in Chapter \@ref(growvr4), as the growth variance model does not change by year. 
...
Next we can assemble the kernel function. I have removed the comments to save space; refer to Chapter \@ref(buildipm4) for further explanation.
```{r}
